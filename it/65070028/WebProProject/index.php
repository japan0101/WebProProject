...
<head>
    ...
    <link rel="stylesheet" href="/it/65070028/WebProProject/assets/stylesheets/developers.css">
    <link rel="stylesheet" href="/it/65070028/WebProProject/assets/stylesheets/navbar.css">
    <link rel="stylesheet" href="/it/65070028/WebProProject/assets/stylesheets/global.css">
</head>

<body class="antialiased">
<?php
include($_SERVER['DOCUMENT_ROOT'] . "/it/65070028/WebProProject/assets/component/navCustomer.php") ?>
    ...
    <section class="body_container">
        <section id="developers">
                ...
                <div class="flex flex-col" style="width: 100%">
                    ...
                    <div class="flex flex-row gap-3 justify-between mt-5">
                        <div id="mark-facebook" class="flex flex-col social-media-small-box facebook text-white">
                            <img src="/it/65070028/WebProProject/assets/icon/facebook.svg" alt="Facebook">
                            <h5 class="text-white">Facebook</h5>
                        </div>
                        <div id="mark-dis" class="flex flex-col social-media-small-box discord">
                            <img src="/it/65070028/WebProProject/assets/icon/discord.svg" alt="Discord">
                            <h5 class="text-white">Discord</h5>
                        </div>
                        <div id="mark-git" class="flex flex-col social-media-small-box github">
                            <img src="/it/65070028/WebProProject/assets/icon/github.svg" alt="Github">
                            <h5 class="">GitHub</h5>
                        </div>
                        <div id="mark-none" class="flex flex-col social-media-small-box">
                            <img alt="" src="/it/65070028/WebProProject/assets/icon/microsoft-edge.webp">
                            <h5>Something else...</h5>
                        </div>
                    </div>
                </div>
                <div class="object-contain flex flex-col self-center" style="width: 90%;">
                    <img alt="" src="/it/65070028/WebProProject/assets/images/developers/mark.webp" width="">
                </div>
            </div>
            <div id="best" class="dev-box mt-6 flex flex-row container_rounded bg-white justify-center">
                ...
                <div class="object-contain flex flex-col self-center" style="width: 90%;">
                    <img alt="" src="/it/65070028/WebProProject/assets/images/developers/best.webp" width="">
                </div>
            </div>
            <div id="japan" class="dev-box mt-6 flex flex-row container_rounded bg-white justify-center">
                ...
                <div class="object-contain flex flex-col self-center" style="width: 90%;">
                    <img alt="" src="/it/65070028/WebProProject/assets/images/developers/Japan.webp" width="">
                </div>
            </div>
            <div id="tae" class="dev-box mt-6 flex flex-row container_rounded bg-white justify-center">
                ...
                <div class="object-contain flex flex-col self-center" style="width: 90%;">
                    <img alt="" src="/it/65070028/WebProProject/assets/images/developers/tae_prepro.webp" width="">
                </div>
            </div>
            <script src="/it/65070028/WebProProject/assets/scripts/developer.js"></script>
        </section>
    </section>
