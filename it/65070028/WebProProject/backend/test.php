...
<div class="m-5">
    ...
    <form class="m-3" action="/it/65070028/WebProProject/backend/database/manager.php" method="post">
    ...
    <!-- Modify Menu -->
    <div>
        <form class="m-3" action='/it/65070028/backend0028/backend/database/manager.php' method='post'>
...
<div class="m-5">
    ...
    <form class="m-3" action='/it/65070028/backend0028/backend/database/staff.php' method='post'>
...
<div class="m-5">
    ...
    <form class="m-3" action="/it/65070028/WebProProject/backend/database/customer.php" method="post">
