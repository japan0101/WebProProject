...
if (isset($_SESSION['memberName'])) { ?>
    ...
    <form action="/it/65070028/WebProProject/backend/database/customer.php" method="post" id="buyCoupon">
...
<script>
    fetch("./../../backend/database/customer.php?case=category").then(e => e.json()).then(payload => {
        ...
        payload.forEach(couponObj => {
            ...
            button.setAttribute('onclick', 'buy(\'' + couponObj['menuID'] + '\', ' + couponObj['cost'] + ', \'' + couponObj['discount'] + '\')')
