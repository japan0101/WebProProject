...
<head>
    ...
    <?php
    include($_SERVER['DOCUMENT_ROOT'] . "/it/65070028/WebProProject/assets/scripts/tailwind.php") ?>
...
if (isset($_COOKIE['tableID'])) { ?>
            ...
            <div class="rounded-lg border dark:border-neutral-600 mt-7">
                <div class="p-4">
                    <div class="sm:flex sm:items-start">
                        <ul class="mr-4 flex list-none sm:flex-col overflow-x-auto pl-0" id="bannerSel" role="tablist"
                            data-te-nav-ref="">
                            <!-- Selector -->
                            <li role="presentation" class="flex-grow text-center">
                                <a href="#allCoupon"
                                   ...
                                   data-te-toggle="pill" data-te-target="#allCoupon" data-te-nav-active role="tab"
                                   aria-controls="allCoupon" aria-selected="true">All</a>
                            </li>
                        </ul>
                        <!-- Coupon Container -->
                        <div class="my-2 grow" id="contentHolder">
                            <div class="hidden opacity-100 transition-opacity duration-150 ease-linear data-[te-tab-active]:block"
                                 id="allCoupon" role="tab" aria-labelledby="allCoupon" data-te-tab-active="">
                                <div class="flex flex-wrap justify-center items-center max-w-[110rem]"
                                     id="allCouponContainer">
    ...
    <div data-te-modal-init
         ...
         id="incart" tabindex="-1" aria-labelledby="incartLabel" aria-hidden="true">
        <div data-te-modal-dialog-ref
            ...
            <div class="min-[576px]:shadow-[0_0.5rem_1rem_rgba(#000, 0.15)] pointer-events-auto relative flex w-full flex-col rounded-md border-none bg-white bg-clip-padding text-current shadow-lg outline-none dark:bg-neutral-600">
                ...
                <div class="relative flex-auto p-4 max-h-72 overscroll-contain overflow-y-auto" data-te-modal-body-ref>
                    ...
                    <div class="self-center">ราคาทั้งหมด: <input class="m-auto border rounded w-1/5 text-center"
                                                                 id="total_price" value="0" min="0" readonly=""> บาท
                    </div>
                </div>

                <!--Modal footer-->
                <form action="/it/65070028/WebProProject/backend/database/customer.php" method="post">
...
<script src="/it/65070028/WebProProject/assets/scripts/sweetalert.js"></script>

<?php
if (!isset($_COOKIE['tableID'])) {
    if (isset($_SESSION['tablecode']))
        header("Location: ./../../backend/checkTable.php") ?>
    ...
    if (!isset($_SESSION['userID'])) { ?>
        ...
        <div data-te-modal-init data-te-backdrop="false"
             ...
             id="loginModal" tabindex="-1" aria-labelledby="loginModalTitle" aria-hidden="true">
            <div data-te-modal-dialog-ref
                ...
                <div class="pointer-events-auto relative flex w-full flex-col rounded-md border-none bg-white bg-clip-padding text-current shadow-lg outline-none dark:bg-neutral-600">
                    ...
                    <div class="relative p-4">
                        <form action="/it/65070028/WebProProject/backend/account/read_user.php" method="post">
                            <!--E-mail input-->
                            <div class="relative mb-5" data-te-input-wrapper-init>
                                <input type="text"
                                       ...
                                       placeholder="Enter email" title='ต้องเป็นอีเมล หรือ หมายเลขโทรศัพท์' required/>
                        ...
                        <form action="/it/65070028/WebProProject/backend/account/anonymous.php" method="post">
        ...
        <div class="undefined transition-all duration-300 ease-in-out fixed top-0 left-0 z-[1040] bg-black w-screen h-screen opacity-50"
    ...
    <?php
        ...
        <div class="flex flex-col h-screen w-screen content-center">
            <div class="m-auto">
                <div class="inline-block h-96 w-96 animate-[spinner-grow_0.75s_linear_infinite] rounded-full bg-current align-[-0.125em] opacity-0 motion-reduce:animate-[spinner-grow_1.5s_linear_infinite]"
                     role="status">
                    <span class="!absolute !-m-px !h-px !w-px !overflow-hidden !whitespace-nowrap !border-0 !p-0 ![clip:rect(0,0,0,0)]">Loading...</span>
                </div>
            </div>
        </div>
        <form action="/it/65070028/WebProProject/backend/database/customer.php" method="post" id="form1">
...
<?php
include($_SERVER['DOCUMENT_ROOT'] . "/it/65070028/WebProProject/assets/scripts/tw_element.php") ?>
