                    ...
                    <div class="sm:flex sm:items-start ">
                        ...
                        <div class="my-2 grow p-3">
                                    ...
                                    <div data-te-modal-dialog-ref
                                        ...
                                        <div class="min-[576px]:shadow-[0_0.5rem_1rem_rgba(#000, 0.15)] pointer-events-auto relative flex w-full flex-col rounded-md border-none bg-white bg-clip-padding text-current shadow-lg outline-none dark:bg-neutral-600">
                                            ...
                                            <div class="flex flex-shrink-0 flex-wrap items-center justify-center rounded-b-md border-t-2 border-neutral-100 border-opacity-100 p-4 dark:border-opacity-50">
                                                <form action="/it/65070028/WebProProject/backend/account/cancelMem_user.php" method="post">
                                                    <button type="submit"
                            ...
                            <div class="hidden opacity-0 transition-opacity duration-150 ease-linear data-[te-tab-active]:block"
                                ...
                                <form action="/it/65070028/WebProProject/backend/account/update_user.php" method="post">
                                    <!-- MemberName -->
                                    <div class="relative mb-6" data-te-input-wrapper-init>
                                        <input type="text"
                            ...
                            <div class="hidden opacity-0 transition-opacity duration-150 ease-linear data-[te-tab-active]:block"
                                ...
                                <!-- Change Password -->
                                <form action="/it/65070028/WebProProject/backend/account/changePassword_user.php" method="post">
                                    <!-- Old Password -->
                                    <div class="relative mb-6" data-te-input-wrapper-init>
                                        <input type="password"
                                               class="peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
