    ...
    <section class="body_container top-item flex flex-col gap-6">
        ...
        <div class="flex flex-col gap-6">
            <div class="flex md:flex-row sm:flex-col flex-col blur-effect rounded-lg p-8 bg-white gap-3">
                <div class="flex-1">
                    <form class="" action="/it/65070028/WebProProject/backend/database/manager.php" method="post">
...
foreach ($data as $item) { ?>
    <div data-te-modal-init
        ...
        <div data-te-modal-dialog-ref
            ...
            <div class="pointer-events-auto relative flex w-full flex-col rounded-md border-none bg-white bg-clip-padding text-current shadow-lg outline-none dark:bg-neutral-600">
                ...
                <!--Modal body-->
                <form class="p-5" action="/it/65070028/WebProProject/backend/database/manager.php" method="post" enctype="multipart/form-data">
                    <div class="relative mb-3" data-te-input-wrapper-init>
                        <input type="text"
                               class="peer block min-h-[auto] w-full rounded border-0 bg-transparent px-3 py-[0.32rem] leading-[1.6] outline-none transition-all duration-200 ease-linear focus:placeholder:opacity-100 peer-focus:text-primary data-[te-input-state-active]:placeholder:opacity-100 motion-reduce:transition-none dark:text-neutral-200 dark:placeholder:text-neutral-200 dark:peer-focus:text-primary [&:not([data-te-input-placeholder-active])]:placeholder:opacity-0"
    ...
    <div data-te-modal-init
        ...
        <div data-te-modal-dialog-ref
            ...
            <div class="pointer-events-auto relative flex w-full flex-col rounded-md border-none bg-white bg-clip-padding text-current shadow-lg outline-none dark:bg-neutral-600">
                ...
                <!--Modal body-->
                <form action="/it/65070028/WebProProject/backend/database/manager.php" method="post">
    ...
    <form action="/it/65070028/WebProProject/backend/database/manager.php" method="post" id="addbanneritem">
        <input type="hidden" name="case" id="case" value="addtobanner">
    </form>
    <form action="/it/65070028/WebProProject/backend/database/manager.php" method="post" id="delbanneritem">
