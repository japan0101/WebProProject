                                  ...
                                  <nav class="relative flex w-full flex-wrap justify-between bg-[#FBFBFB] py-2 text-neutral-500 shadow-lg hover:text-neutral-700 focus:text-neutral-700 dark:bg-neutral-600 lg:py-4 content-center">
                                      <div class="flex w-full flex-wrap items-center justify-between px-3">
                                          ...
                                          <div class="flex place-self-center">
                                              <!-- insert logo -->
                                              <a class="text-xl text-center font-semibold text-neutral-800 dark:text-neutral-200"
                                                 href="#">Table
                                                  #<?php
            ...
            <div class="rounded-lg border dark:border-neutral-600 mt-7">
                <div class="p-4">
                    <div class="sm:flex sm:items-start">
                        <ul class="mr-4 flex list-none sm:flex-col overflow-x-auto pl-0" id="categorySel" role="tablist"
                            data-te-nav-ref="">
                            <!-- Selector -->
                            <li role="presentation" class="flex-grow text-center">
                                <a href="#allMenu"
                                   ...
                                   data-te-toggle="pill" data-te-target="#allMenu" data-te-nav-active role="tab"
                                   aria-controls="allMenu" aria-selected="true">All</a>
                            </li>
                        </ul>
                        <!-- Coupon Container -->
                        <div class="my-2 grow" id="contentHolder">
                            <div class="hidden opacity-100 transition-opacity duration-150 ease-linear data-[te-tab-active]:block"
                                 id="allMenu" role="tab" aria-labelledby="allMenu" data-te-tab-active="">
                                  ...
                                  <div data-te-modal-init
                                      ...
                                      <div data-te-modal-dialog-ref
                                          ...
                                          <div class="min-[576px]:shadow-[0_0.5rem_1rem_rgba(#000, 0.15)] pointer-events-auto relative flex w-full flex-col rounded-md border-none bg-white bg-clip-padding text-current shadow-lg outline-none dark:bg-neutral-600">
                                              ...
                                              <!--Modal body-->
                                              <div class="relative flex-auto p-4 max-h-72 overscroll-contain overflow-y-auto"
                                                   data-te-modal-body-ref>
                                                  <ul class="" id="order_show">

                                                  </ul>
                                                  <div class="self-center">ราคาทั้งหมด: <input
                                                              class="m-auto border rounded w-1/5 text-center"
...
<?php
                                                                    ...
                                                                    <div data-te-modal-dialog-ref
                                                                        ...
                                                                        <div class="pointer-events-auto relative flex w-full flex-col rounded-md border-none bg-white bg-clip-padding text-current shadow-lg outline-none dark:bg-neutral-600">
                                                                            ...
                                                                            <div class="relative p-4">
                                                                                <form action="./../../backend/account/read_user.php"
                                                                                      method="post">
                                                                                    <!--E-mail input-->
                                                                                    <div class="relative mb-5"
                                                                                        ...
                                                                                        <input type="text"
                                                                                               ...
                                                                                               title='ต้องเป็นอีเมล หรือ หมายเลขโทรศัพท์'
                                                                                               required/>
                                                                                ...
                                                                                <form action="./../../backend/account/anonymous.php"
                                                                                      method="post">
                    ...
                    align-[-0.125em] opacity-0 motion-reduce:animate-[spinner-grow_1.5s_linear_infinite]" role="status">
                        ...
                        ![clip:rect(0,0,0,0)]">Loading...</span>
                                                                ...
                                                                <form action="./../../backend/database/customer.php"
