                                        ...
                                        <tr class="border-b dark:border-neutral-500">
                                            ...
                                            <td class="whitespace-nowrap px-6 py-4">
                                                <button data-te-toggle="modal" data-te-target="#<?php
                                                    echo "menu_modify{$item->menuID}" ?>" type="button"
                                                        data-te-ripple-init
                                            ...
                                            <td class="whitespace-nowrap px-6 py-4">
                                                <button data-te-toggle="modal" data-te-target="#<?php
                                                    echo "menu_delete{$item->menuID}" ?>" type="button"
                                                        data-te-ripple-init
                                                        data-te-ripple-color="light"
...
<?php
    foreach ($data as $item) { ?>
        <div data-te-modal-init
             ...
             id="menu_modify<?php
                 echo $item->menuID ?>" tabindex="-1" aria-labelledby="exampleModalCenterTitle" aria-modal="true"
             role="dialog">
