            ...
            <form method="post" action="./../backend/account/read_user.php">
              ...
              <div class="text-center lg:text-left">
                ...
                <p class="mb-0 mt-2 pt-1 text-sm font-semibold">
                  ไม่มีบัญชี?
                  <a href="register.php" class="text-danger transition duration-150 ease-in-out hover:text-danger-600 focus:text-danger-600 active:text-danger-700">สมัครสมาชิก</a>
                </p>
              </div>
            </form>
                    ...
                    <?php for ($i = 0; $i < 5; $i++) { ?>
                      <tr class="border-b dark:border-neutral-500">
                        ...
                        <td class="whitespace-nowrap px-6 py-4 text-center grid grid-cols-2 gap-4">
                          <button data-te-ripple-init data-te-ripple-color="light" class="px-3 py-2 rounded-lg bg-primary text-white">คิดเงิน</button>
                          <button data-te-ripple-init data-te-ripple-color="light" class="px-3 py-2 rounded-lg bg-primary text-white">สร้างรหัสเมนู</button>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
