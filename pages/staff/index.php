...
<body>
    ...
    if (!$isAuth) {
        echo '<div class="relative mb-5" data-te-input-wrapper-init>
    ...
    if ($isAuth && ($_SESSION['role'] == "STAFF" || $_SESSION['role'] == "MANAGER")) {
        ...
        <ul
          class="place-content-center mb-5 flex list-none flex-row flex-wrap border-b-0 pl-0"
          role="tablist"
          data-te-nav-ref>
        ...
        <div class="mb-6">
          <div
            class="place-content-center hidden opacity-100 transition-opacity duration-150 ease-linear data-[te-tab-active]:block"
            id="tabs-home"
            role="tabpanel"
        ...
        <div
            ...
            <div
                class="place-content-center hidden opacity-0 transition-opacity duration-150 ease-linear data-[te-tab-active]:block"
                id="tabs-messages"
                role="tabpanel"
                aria-labelledby="tabs-profile-tab">
                Tab 3 content
