        ...
        <div class="mb-6">
            ...
            foreach ($data as $item) { ?>
                ...
                <form action="./../../backend/database/staff.php" method="post">
                    ...
                    <div data-te-modal-init class="fixed left-0 top-0 z-[1055] hidden h-full w-full overflow-y-auto overflow-x-hidden outline-none" id="bill<?php
                                                                                                                                                            echo $item->tableID; ?>" tabindex="-1" aria-labelledby="exampleModalCenterTitle" aria-modal="true" role="dialog">
